    ...
    <>
      ...
      <div className="flex flex-col justify-start items-start my-4 relative">
        ...
        <input
          ...
          autoComplete="off"
          className="text-white w-72 h-10 ml-1 rounded-2xl bg-lightblue pl-3 pr-8 py-2 overflow-y-scroll text-xs placeholder-white hover:bg-lightblue focus:bg-lightblue focus:outline-0"
